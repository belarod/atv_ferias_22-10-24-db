...
INSERT INTO turma (capacidade, id_disciplina, id_semestre, id_aluno) VALUES
(30, 'Programação I', 1, '12345678901'),
(40, 'Matemática Discreta', 1, '23456789012'),
(35, 'Estruturas de Dados', 1, '34567890123'),
(30, 'Banco de Dados', 2, '45678901234'),
(25, 'Sistemas Operacionais', 2, '56789012345'),
(40, 'Redes de Computadores', 2, '67890123456'),
(30, 'Engenharia de Software', 1, '78901234567'),
(25, 'Teoria da Computação', 2, '89012345678'),
(30, 'Desenvolvimento Web', 1, '90123456789'),
(40, 'Inteligência Artificial', 2, '01234567890');
...
DELETE FROM disciplina WHERE id_professor = '22233344455';
DELETE FROM professor WHERE cpf = '22233344455';
--CASCADE--
DELETE FROM professor WHERE cpf = '22233344455';